...
BIRTHDAY = datetime.datetime(2004, 11, 6)
...
SIMPLE_ROW_SPECS = (
    ...
    (
        "languages_programming_dots",
        "languages_programming_value",
        ". Languages.Programming:",
    ),
    ("languages_computer_dots", "languages_computer_value", ". Languages.Computer:"),
    ("languages_real_dots", "languages_real_value", ". Languages.Real:"),
    ("hobbies_software_dots", "hobbies_software_value", ". Hobbies.Software:"),
    ("hobbies_systems_dots", "hobbies_systems_value", ". Hobbies.Systems:"),
    ("hobbies_others_dots", "hobbies_others_value", ". Hobbies.Others:"),
