...
SIMPLE_IDS = {
    ...
    "ide_dots", "ide_value",
    "languages_programming_dots", "languages_programming_value",
    "languages_computer_dots", "languages_computer_value",
    "languages_real_dots", "languages_real_value",
    "hobbies_software_dots", "hobbies_software_value",
    "hobbies_systems_dots", "hobbies_systems_value",
    "hobbies_others_dots", "hobbies_others_value",
...
class SimpleRowTests(unittest.TestCase):
    ...
    def test_longer_language_value_reduces_padding(self):
        ...
        today.align_simple_rows(root)
        before = today.require_svg_element(root, "languages_programming_dots").text or ""
        value = today.require_svg_element(root, "languages_programming_value")
        value.text = "Python, TypeScript, C#, JavaScript"
        today.align_simple_rows(root)
        after = today.require_svg_element(root, "languages_programming_dots").text or ""
